...
CREATE POLICY IF NOT EXISTS "Allowed roles can view product prices"
...
CREATE POLICY IF NOT EXISTS "Allowed roles can manage product prices"
ON public.product_prices
FOR INSERT
WITH CHECK (
  EXISTS (
...
CREATE POLICY IF NOT EXISTS "Allowed roles can update product prices"
ON public.product_prices
FOR UPDATE
USING (
  EXISTS (
...
-- Optionally allow farm_owner to delete
CREATE POLICY IF NOT EXISTS "Farm owner can delete product prices"
ON public.product_prices
FOR DELETE
USING (
  EXISTS (
